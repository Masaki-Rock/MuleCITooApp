...
public class RuntimeAlertRequest {
	...
	private void setCPUUsageAlert() {
		this.name = String.format("[%s] CPU usage threshold exceeded alert", Const.ENV);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject",String.format("[%s] ${severity}: CPU usage ${state}", Const.ENV));
		action.put("content","Hello,\nYou are receiving this alert because:\nThe application ${resource} is now in an ${state} state, based on the condition 'CPU ${operator} ${value}%'.");
	...
	private void setDeployfailedAlert() {
		this.name = String.format("[%s] Deploy failed alert", Const.ENV);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject",String.format("[%s] ${severity}: Deployment Failed", Const.ENV));
	...
	private void setMemoryUsageAlert() {
		this.name = String.format("[%s] Memory usage threshold exceeded alert", Const.ENV);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject",String.format("[%s] ${severity}: memory usage ${state}", Const.ENV));
	...
	private void setWorkerNotRespondingAlert() {
		this.name = String.format("[%s] Worker not responding alert", Const.ENV);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject",String.format("[%s] ${severity}: Worker unresponsive", Const.ENV));
	...
	private void setCustomApplicationNortificationAlert() {
		this.name = String.format("[%s] Custom application nortification alert", Const.ENV);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject", String.format("[%s] ${severity}: Custom Application Notification", Const.ENV));
	...
	private void setExceedEventTrafficThreshholdAlert() {
		this.name = String.format("[%s] Event traffic threshold exceeded alert", Const.ENV);
//		this.severity = "CRITICAL";
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type","email");
		action.put("subject",String.format("[%s] ${severity}: Event Threshold Exceeded", Const.ENV));
